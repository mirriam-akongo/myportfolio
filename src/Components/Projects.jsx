      ...
      return (
        <div className='projects-grid'>
          ...
          <Card shadow={5} style={{ minWidth: '450px', margin: 'auto' }}>
            ...
            <CardText style={{ fontSize: '20px', color: '#10292e' }}>
              This is a Website to demostrate a few things I learnt in reactjs
            </CardText>
            <CardActions border>
              <Button colored>
                <a
                  href='https://github.com/mirriam-akongo/myportfolio/tree/react'
                  target='_blank'
      ...
      return (
        <div>
          ...
          <Card shadow={5} style={{ minWidth: '450px', margin: 'auto' }}>
            ...
            <CardText style={{ fontSize: '20px', color: '#10292e' }}>
              A simple node js application where I built an API and used MongoDB
              as my database
            </CardText>
            <CardActions border>
              <Button colored>
      ...
      return (
        <div>
          ...
          <Card shadow={5} style={{ minWidth: '450px', margin: 'auto' }}>
            ...
            <CardText style={{ fontSize: '20px', color: '#10292e' }}>
              This is a Website to built using HTML, CSS and JavaScript
            </CardText>
            <CardActions border>
              <Button colored>
                <a
                  href='https://github.com/mirriam-akongo/UI-EDU-Online-Shopping'
                  target='_blank'
                  rel='noopener noreferrer'
                  style={{ color: '#10292e' }}
                >
